...
from model.blocks.neck_blocks import ASPP_Module, DimReduce


class aspp_neck(torch.nn.Module):
    def __init__(self, in_channel_list=[128, 256, 512, 1024], out_channel=256):
        ...
        # swin<->in_channel_list: [128, 256, 512, 1024]
