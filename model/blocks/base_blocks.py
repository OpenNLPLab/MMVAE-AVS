...
from model.blocks.my_upsample import upsample_deterministic, UpsampleDeterministic
...
class FeatureFusionBlock(nn.Module):
    ...
    def forward(self, *xs):
        ...
        if len(xs) == 2:
            ...
            output = upsample_deterministic(output, upscale=2)
...
class SimpleHead(nn.Module):
    def __init__(self, channel, rate):
        ...
        # nn.Upsample(scale_factor=rate, mode='bilinear', align_corners=True)
